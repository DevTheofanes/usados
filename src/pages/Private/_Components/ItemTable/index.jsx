...
export const DashboardItemTable = props => {
  ...
  return (
    <Content>
      <Infos>
        <Thumbnail src={classified ? `${host}/files/${classified.mainImageUrl}` : "https://images.unsplash.com/photo-1568605117036-5fe5e7bab0b7?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=2000&q=80"} alt={classified ? classified.title : "Hb20"} />
        <InfoTextContainer>
        ...
        >
          {
            close => (
              <ModalConfirmDeleteContainer>
                ...
                <ConfirmDeleteContent>
                  <p>Se você confirmar, os dados seram apagados do nosso banco de dados e não será possivel resgatar os mesmos no futuro.</p>
                  ...
                  <ModalConfirmDeleteButtonsContainer>
                    ...
                    <button className="btnDelete" onClick={() => handleDeleteItem(classified.id, close)}>Apagar</button>
                  </ModalConfirmDeleteButtonsContainer>
                </ConfirmDeleteContent>
              </ModalConfirmDeleteContainer>
            )
