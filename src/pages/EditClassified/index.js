      ...
      <Content>
        ...
        <SignUpContainer>
          <FormColumn>
              ...
              <select onChange={(e) => setCategory(e.target.value)}>
                {
                  categories.map(category => (
                    <option key={category.id} value={category.id} selected={String(category.id) === category ? true : null}>{category.name}</option>
                  ))
                }
              </select>
            </FormInput>
            ...
            <FormInputCheckBox>
              <input type="checkbox" name="Novo" id="Novo" checked={isDelivered} onChange={() => setIsDelivered(!isDelivered)} />
              <span>Faço entrega</span>
            </FormInputCheckBox>

            <FormInputCheckBox>
              <input type="checkbox" name="Novo" id="Novo" checked={isPix} onChange={() => setIsPix(!isPix)} />
